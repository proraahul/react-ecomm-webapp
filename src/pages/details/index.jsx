                    ...
                    <div className="grid grid-cols-12">
                        ...
                        <div className="col-span-8 ml-7 product-info">
                            ...
                            <div className="flex items-center my-2">
                                <span className='text-custom-green font-medium text-4xl mr-3'>$38</span> <span className='text-lg opacity-50 text-black line-through relative ml-2 font-medium mt-2'>$52</span>
                                <span className="text-[#FDC040] absolute left-[615px] text-xs top-[443px]">26% Off</span>
                            </div>
                            <p className="text-[#7E7E7E] pr-10 a">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Velit impedit fugiat voluptate expedita, officiis autem cum dolore eum repellendus ad non, nesciunt, cumque rerum ullam!
                            </p>
                            <p className="text-[#7E7E7E] pr-10 ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure voluptatibus cumque eius dolores quia aliquam soluta tenetur laborum quasi excepturi.</p>

                            {/* size and weight */}
                            <div className="w-full h-auto flex items-center gap-x-2 opacity-80 my-4 product-size">
